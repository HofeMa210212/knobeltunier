...
Future<Database> dbController() async {
  ...
  String dbPath = p.join(dbDir.path, 'knobeltunier.db');
...
Future<void> addMatchDb(Database db, int? matchPlayer1Id, int? matchPlayer2Id, String place, String? startTime, int tournamentId, int matchNumber) async {
